...
params.hiddenMetavariable = 0; % Not a hidden metavariable setup
params.staticMetavariable = 0; % Not a static metavariable setup

%******* Variation Operators **********
params.pairingOperator = @Pairing_Random; % Pairing Method
params.crossoverOperator = @Crossover_Spatial; % Crossover Method
params.crossoverRate = 0.8; 

params.mutationOperator = @Mutation_Random;
...
params.filterRepairOperator = @Filter_Window; % Repair/filter function
...
%******* Window function ************
params.windowFunction = @WindowFunction_Fixed;

%******* Local Selection ********
params.localSelectionOperator = @LocalSelection_Tournament;
